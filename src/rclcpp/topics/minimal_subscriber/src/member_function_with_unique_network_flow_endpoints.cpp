/***
 * @Author: cao.guanghua
 * @Date: 2025-08-28 10:01:17
 * @LastEditTime: 2025-08-28 10:01:17
 * @LastEditors: cao.guanghua
 * @Description:
 * @FilePath: /src/rclcpp/topics/minimal_subscriber/src/member_function_with_unique_network_flow_endpoints.cpp
 */
...
{
public:
    MinimalSubscriberWithUniqueNetworkFlowEndpoints() : Node("minimal_subscriber_with_unique_network_flow_endpoints")
    {
        try
        {
            auto options_1 = rclcpp::SubscriptionOptions();
            options_1.require_unique_network_flow_endpoints = RMW_UNIQUE_NETWORK_FLOW_ENDPOINTS_STRICTLY_REQUIRED;

            subscription_1_ = this->create_subscription<std_msgs::msg::String>(
                "topic_1", 10, std::bind(&MinimalSubscriberWithUniqueNetworkFlowEndpoints::topic_1_callback, this, _1), options_1);

            auto options_2 = rclcpp::SubscriptionOptions();
            subscription_2_ = this->create_subscription<std_msgs::msg::String>("topic_2", 10, std::bind(&MinimalSubscriberWithUniqueNetworkFlowEndpoints::topic_2_callback, this, _1), options_2);
